...
data class MockUser(override val size: Int): List<User>{
    ...
    private fun generateMockUsers(): List<User?> {
        ...
        return listOf(
            User(10, "Albert", 1, "https://picsum.photos/seed/picsum/200/200"),
            User(11, "Bernard",1, "https://picsum.photos/seed/picsum/200/200"),
            User(12, "Charles", 1,"https://picsum.photos/seed/picsum/200/200"),
            User(13, "Derrick", 1, "https://picsum.photos/seed/picsum/200/200")
        )
    }
